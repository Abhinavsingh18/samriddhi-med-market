          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex">
                  <div className="h-12 w-12 rounded-full bg-medical-50 flex items-center justify-center flex-shrink-0">
                    <span className="text-medical-700 text-2xl">✉️</span>
                  </div>
                  <div className="ml-4">
                    <h3 className="text-lg font-medium mb-1">Email Us</h3>
                    <p className="text-gray-600">
                      <a href="mailto:info@samriddhienterprises.com" className="text-medical-600 hover:underline">
                        info@samriddhienterprises.com
                      </a><br />
                      <a href="mailto:sales@samriddhienterprises.com" className="text-medical-600 hover:underline">
                        sales@samriddhienterprises.com
                      </a>
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+919876543210" className="text-medical-600 hover:underline">
                        +91 9876543210
                      </a><br />
                      <a href="tel:+918012345678" className="text-medical-600 hover:underline">
                        +91 8012345678
                      </a>
                    </p>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="h-10 w-10 rounded-full bg-medical-50 flex items-center justify-center text-medical-700 hover:bg-medical-100 transition-colors">
